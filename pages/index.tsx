...
const Home = ({ pageInfo, experiences, projects, skills, socials }: Props) => {
	return (
		...
		<div className="relative z-0 h-screen overflow-y-scroll break-words bg-[rgb(36,36,36)] text-white overflow-x-hidden scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80 sm:scrollbar-thin ">
			<Head>
